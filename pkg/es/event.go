...
func NewEventFromRecorded(event *kurrentdb.RecordedEvent) Event {
	return Event{
...
func NewEventFromEventData(event kurrentdb.EventData) Event {
	return Event{
		EventID:   event.EventID.String(),
		EventType: event.EventType,
		Data:      event.Data,
...
func EventFromEventData(recordedEvent kurrentdb.RecordedEvent) (Event, error) {
	return Event{
...
func (e *Event) ToEventData() kurrentdb.EventData {
