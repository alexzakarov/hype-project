...
type Logger interface {
	...
	ProjectionEvent(projectionName string, groupName string, event *kurrentdb.ResolvedEvent, workerID int)
}
...
func (l *appLogger) ProjectionEvent(projectionName string, groupName string, event *kurrentdb.ResolvedEvent, workerID int) {
	l.logger.Debug(
		projectionName,
